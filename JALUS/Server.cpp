...
void Server::init(ServerRole serverRole)
{
	...
	Accounts::init("Accounts", "id BIGINT(20) AUTO_INCREMENT PRIMARY KEY, username CHAR(32), password_hash CHAR(128), login_tries TINYINT(1) NOT NULL DEFAULT 0, locked_timestamp BIGINT(20) NOT NULL DEFAULT -1, front_character BIGINT(20) NOT NULL DEFAULT -1, trust_level TINYINT NOT NULL DEFAULT 0");
